...
casefolder=$inputdir/casefolder						#path of folder with BAMs used as case for DS analysis; needs to be filled when differential=1; filled like bamfolder
casefastq=$inputdir/casefastq						#path of folder with fastq files used as case for DS analysis
caseprefix="subsample_0"						#all files in the casefastq folder must have this by the user specified prefix
controlfolder=$inputdir/controlfolder					#path of folder with BAMs used as control for DS analysis; needs to be filled when differential=1; filled like bamfolder
controlfastq=$inputdir/controlfastq					#path og folder with fastq files used as control for DS analysis
