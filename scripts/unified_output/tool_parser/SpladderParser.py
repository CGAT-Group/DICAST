...
def parseA3(alt_3prime_line, combine_me):
    ...
    if strand == "+":
        return {A3Event(idx, alt_3prime_line[8], str(int(alt_3prime_line[6])+1), strand, gene, symbol)}
    else:
        return {A3Event(idx, str(int(alt_3prime_line[7])+1), alt_3prime_line[9], strand, gene, symbol)}
...
def parseA5(alt_5prime_line, combine_me):
    ...
    if strand == "+":
        return {A5Event(idx, str(int(alt_5prime_line[7])+1), alt_5prime_line[9], strand, gene, symbol)}
    else:
        return {A5Event(idx, alt_5prime_line[8], str(int(alt_5prime_line[6])+1), strand, gene, symbol)}
